...
class Companies_model extends CI_Model
{
    ...
    {
        $this->db->select("id, (CASE WHEN customer_no = '' THEN name ELSE CONCAT(name, '(', customer_group_name ,')', ': ', phone, ' # " . $lbl_award_points . ": ', award_points, '  (', customer_no, ')' ) END) as text, customer_group_name, customer_group_id", FALSE);
