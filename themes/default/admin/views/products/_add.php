                    ...
                    <div class="standard">
                        ...
                        <div class="well well-sm" id="attr-con">
                            ...
                            <table class="table-responsive">
                                ...
                                <table id="increaseQty" class="table table-condensed table-striped"
                                style="<?= $this->input->post('attributes') || $product_options ? '' : 'display:none;'; ?>margin-bottom: 0; margin-top: 10px;">
                                    <tr>
                                        <td style="width: 20%">
                                            <button type="button" class="btn btn-warning btn-block" id="x1" style="height:45px; font-size: 25px; width: 70px">=1</button>
                                        </td>
                                        <td style="width: 20%">
                                            <button type="button" class="btn btn-warning btn-block" id="x2" style="height:45px; font-size: 25px; width: 70px">X2</button>
                                        </td>
                                        <td style="width: 20%">
                                            <button type="button" class="btn btn-warning btn-block" id="x3" style="height:45px; font-size: 25px; width: 70px">X3</button>
                                        </td>
                                        <td style="width: 20%">
                                            <button type="button" class="btn btn-warning btn-block" id="x4" style="height:45px; font-size: 25px; width: 70px">X4</button>
                                        </td>
                                        <td style="width: 20%">
                                            <button type="button" class="btn btn-warning btn-block" id="x5" style="height:45px; font-size: 25px; width: 70px">X5</button>
                                        </td>
...
//});
        ...
        $(document).on('click', '#x2', function () {
            $.each(warehouses, function () {
                if (!isNaN(parseInt($('#wh_qty_' + this.id).val()))) {
                    //current_qty = parseInt($('#wh_qty_' + this.id).val());
                    //$('#attrTable').find('.quantity').find('input').val(2);
                    //$('#attrTable').find('.quantity').find('span').text(2);
                    var total = 0;
                    $('#attrTable').find(".quantity").each( function(){
                        $(this).find('input').val(2);
                        $(this).find('span').text(2);
                        total += parseFloat($(this).find('input').val()) || 0;
                    });

                    $('#wh_qty_' + this.id).val(total);
                }
            });
