...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            "aaSorting": [[0, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, 250, 500, 800, -1], [10, 25, 50, 100, 250, 500, 800, "<?= lang('all') ?>"]],
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            <a href="#" id="updateSupplier" data-action="supplier">
                                <i class="fa fa-user-plus"></i> <?= lang('update_supplier') ?>
                            </a>
                        </li>
...
<script>
    $(document).ready(function () {
        $('#POSData_wrapper :input[type="text"]').first().focus();
    });
</script>