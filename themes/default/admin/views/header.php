                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_shopee_exporter">
                                        <a class="submenu" href="<?= admin_url('products/shopee_exporter'); ?>">
                                            <i class="fa fa-file-excel-o"></i>
                                            <span class="text"> <?= lang('shopee_exporter'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>                                        
                                        ...
                                        <?php if (POS) { ?>
                                            ...
                                            <li id="system_settings_size_group">
                                                <a href="<?= admin_url('system_settings/size_group') ?>">
