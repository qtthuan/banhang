...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input name="no_points" type="checkbox" class="checkbox" id="no_points" value="1" <?= empty($category->no_points) ? '' : 'checked="checked"' ?>/>
                <label for="no_points" class="padding05"><?= lang('category_no_points') ?></label>
            </div>
