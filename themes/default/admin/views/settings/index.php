                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info" role="alert"><p>
                            <strong>Cron Job:</strong> <code>0 1 * * * wget -qO- <?= admin_url('cron/run'); ?> &gt;/dev/null 2&gt;&amp;1</code> to run at 1:00 AM daily. For local installation, you can run cron job manually at any time.
                            <?php if (!DEMO) { ?>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-1 col-xs-1 text-center" style="padding-top: 35px;"><i class="fa fa-arrow-right"></i>
                                    </div>
                                    <div class="col-sm-4 col-xs-5">
                                        <label class="control-label"><?= lang("award_points"); ?></label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="row" style="padding-top: 10px;">
                                    <div class="col-sm-4 col-xs-6">
                                        <label class="control-label"><?= lang("group_chg_points_minimum"); ?></label>
                                        <?php
                                        $data = array(
                                            'name' => 'chg_points_minimum',
                                            'id'   => 'chg_points_minimum',
                                            'class'=> 'form-control',
                                            'type' => 'number',
                                            'value' => $Settings->chg_points_minimum,
                                            'required' => 'required'
                                        );
                                        echo form_input($data); ?>
                                    </div>
                                    <div class="col-sm-1 col-xs-1 text-center" style="padding-top: 35px;"><i class="fa fa-arrows-h"></i>
                                    </div>
                                    <div class="col-sm-4 col-xs-5">
                                        <label class="control-label"><?= lang("group_chg_points_maximum"); ?></label><br>
                                        <?php
                                        $data = array(
                                            'name' => 'chg_points_maximum',
                                            'id'   => 'chg_points_maximum',
                                            'class'=> 'form-control',
                                            'type' => 'number',
                                            'value' => $Settings->chg_points_maximum,
                                            'required' => 'required'
                                        );
                                        echo form_input($data); ?>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="row" style="padding-top: 10px;">
                                    <div class="col-sm-4 col-xs-6">
                                        <label for="expire_days"><?php echo $this->lang->line("group_expire_days"); ?></label>
                                        <div class="controls">
                                            <?php
                                            $data = array(
                                                'name' => 'expire_days',
                                                ...
                                                'class'=> 'form-control',
                                                'type' => 'number',
                                                'value' => $Settings->expire_days,
                                                'required' => 'required',
                                                'placeholder' => $this->lang->line('group_expire_days_txt')
                                            );
                                            echo form_input($data); ?>
                                        </div>
                                    </div>
