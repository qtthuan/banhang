...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <div class="controls">
                    <input name="no_points" type="checkbox" class="checkbox" id="no_points" value="1" <?= isset($_POST['no_points']) ? 'checked="checked"' : '' ?>/>
                    <label for="no_points">&nbsp;<?php echo $this->lang->line("category_no_points"); ?></label>
                </div>
            </div>
