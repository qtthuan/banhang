                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $transfer->transfer_no), 'class="form-control input-tip" id="ref" required="required"'); ?>
                            </div>
                        </div>
