        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <?= lang('customers_info', 'customers_info'); ?>
                            <?= form_input('customers_info', $pos->customers_info, 'class="form-control tip" id="customers_info"'); ?>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <?= lang('gift_card', 'gift_card'); ?>
                            <?= form_input('gift_card', $pos->gift_card, 'class="form-control tip" id="gift_card"'); ?>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <?= lang('bill_discount', 'bill_discount'); ?>
                            <?= form_input('bill_discount', $pos->bill_discount, 'class="form-control tip" id="bill_discount"'); ?>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <?= lang('bill_shipping', 'bill_shipping'); ?>
                            <?= form_input('bill_shipping', $pos->bill_shipping, 'class="form-control tip" id="bill_shipping"'); ?>
                        </div>
                    </div>
