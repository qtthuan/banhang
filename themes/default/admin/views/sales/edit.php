...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('slreturn', '<?= $inv->return_amount ?>');
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                            ...
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls">
                                    <table id="slTable"
                                        ...
                                        <thead>
                                        <tr>
                                            <th class="col-md-4"><?= lang('product'); ?></th>
                                            <?php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang("return_sale", "slreturn"); ?>
                            <?php echo form_input('returns', '', 'class="form-control input-tip" id="slreturn"'); ?>
                        </div>
                    </div>
                ...
                <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            <td style="width: 13%"><?= lang('items') ?> <span class="totals_val pull-right" id="titems">0</span></td>
                            <td><?= lang('total') ?> <span class="totals_val pull-right" id="total">0.00</span></td>
                            <?php if (($Owner || $Admin || $this->session->userdata('allow_discount')) || $inv->total_discount) { ?>
                            <td><?= lang('order_discount') ?> <span class="totals_val pull-right" id="tds">0.00</span></td>
                            <?php } ?>
                            <td><?= lang('return_sale') ?> <span class="totals_val pull-right" id="treturn">0.00</span></td>
                            <td><?= lang('shipping') ?> <span class="totals_val pull-right" id="tship">0.00</span></td>
                            <td style="width: 21%"><?= lang('grand_total') ?> <span class="totals_val pull-right" id="gtotal">0.00</span></td>
                        </tr>
                    </table>
                </div>
