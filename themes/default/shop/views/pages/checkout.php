                                    ...
                                    <div class="tab-content padding-lg">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade in active" id="guest">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="checkbox bg pull-right" style="margin-top: 0; margin-bottom: 0; color: blue;">
                                                        <label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <?= lang('full_name', 'shipping_name'); ?> *
                                                                <?= form_input('shipping_name', set_value('shipping_name'), 'class="form-control" id="shipping_name" required="required"'); ?>
                                                            </div>
                                                        </div>                                                    
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <?= lang('order_note', 'comment'); ?>
                                                        <?=form_textarea('comment', '', 'id="comment" class="form-control kb-text skip" style="height: 85px; color: #006400;" placeholder="' . lang('order_note_placeholder') . '" maxlength="500"');?>
                                                    </div>
                                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-borderless cart-totals margin-bottom-no">
                                        ...
                                        <tr>
                                            <td><?= lang('shipping'); ?> (<?= lang('shipping_rate_info'); ?>)</td>
